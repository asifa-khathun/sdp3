...
Search by Date :  <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by date" title="Type in a name">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Search by Role :  <input type="text" id="myInput1" onkeyup="myFunction1()" placeholder="Search by role" title="Type in a name">
<br>
